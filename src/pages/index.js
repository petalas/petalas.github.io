...
const IndexPage = () => (
  <Layout>
    ...
    <div class="flex-1 text-primary-500 flex flex-col lg:flex-row text-xs lg:text-sm">

      <section class="p-2 rounded-b-xl lg:rounded-bl-none lg:rounded-r-xl flex flex-row bg-secondary-900 border-primary-300 lg:flex-col border-b-2 mb-2 mr-0 lg:mb-0 lg:mr-2 lg:border-b-0 lg:border-r-2">
        <StaticImage
