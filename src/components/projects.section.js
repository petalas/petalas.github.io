    ...
    return (
        <section {...props} className="grid grid-cols-2 gap-2">
            ...
            <section className="project-tile">
                <a href="https://github.com/WebmasterNikos/btc-risk-metric" target="_blank" className="text-lg hover:text-primary-500">BTC Risk Metric</a>
                <StaticImage
                    className="w-full"
                    loading="eager"
            ...
            <section className="project-tile">
                <a href="https://artgen.xyz/" target="_blank" className="text-lg hover:text-primary-500">artgen.xyz</a>
                <StaticImage
                    className="w-full"
                    loading="eager"
