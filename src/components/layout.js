  ...
  return (
    <>
      <div class="min-h-screen flex flex-col justify-between items-stretch bg-primary-800">
        <main class="flex flex-col flex-1 max-w-sm lg:max-w-2xl xl:max-w-4xl self-center items-center m-2 bg-secondary-600 shadow-lg rounded-xl text-primary-400 opacity-95">
          {children}
        </main>
