(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();const u=`<svg viewBox="0 0 100 100">
    ...
    <svg viewBox="0 0 846.66 846.66">
      ...
      />
    </svg>`,g=`<svg x="0px" y="0px" viewBox="0 0 100 100">
  ...
  <path
...
</svg>`,v=`<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>`,y=`<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
  ...
  `,S=[{title:"Founder and Lead Engineer",name:"DailyGoal.fit",timeframe:"Feb 2025 - Present",description:`
    ...
    `}];function L(e){e&&(e.innerHTML=`© ${new Date().getFullYear()}, Nick Petalas`)}function H(e){e&&(e.innerHTML=`
  ...
  `;function V(e){var p;if(!e)return;e.innerHTML=`
    <div id="nav-toggle">${g}</div>
    <ul id="nav-list" class="hidden flex-col fixed top-0 w-full mx-auto md:relative md:flex md:flex-row md:container md:h-full">
      <li class="nav-item"><a href="#about">${y}<span>About</span></a></li>
      <li class="nav-item"><a href="#experience">${v}<span>Experience</span></span></a></li>
  ...
  `;const t=document.querySelector("#nav-list"),n=document.querySelector("#nav-toggle"),r=(i=!0)=>{window.requestAnimationFrame(()=>{i?(a(),c()):(s(),h())})},a=()=>{var i,o;(i=t==null?void 0:t.classList)==null||i.add("hidden"),(o=t==null?void 0:t.classList)==null||o.remove("flex")},s=()=>{var i,o;(i=t==null?void 0:t.classList)==null||i.remove("hidden"),(o=t==null?void 0:t.classList)==null||o.add("flex"),console.log(t==null?void 0:t.classList)},c=()=>{var i,o;(i=n==null?void 0:n.classList)==null||i.remove("hidden"),(o=n==null?void 0:n.classList)==null||o.add("nav-toggle")},h=()=>{var i,o;(i=n==null?void 0:n.classList)==null||i.add("hidden"),(o=n==null?void 0:n.classList)==null||o.remove("nav-toggle")};n.onclick=()=>r(!1);const l=t==null?void 0:t.children;for(let i=0;i<((l==null?void 0:l.length)??0);i++)(p=l==null?void 0:l[i])==null||p.addEventListener("click",()=>r(!0));const d=document.querySelector("#theme-button");d.onclick=()=>{document.body.classList.toggle("dark"),document.body.classList.contains("dark")?d.innerHTML="🌞":d.innerHTML="🌓"}}function D(e){e&&(e.innerHTML=`
    ${$.map(Z).join("")}
  `)}const Z=e=>`
    <div class="project">
  ...
  `,$=[{name:"DailyGoal.fit",link:"https://dailygoal.fit",img:"images/dailygoal.avif",description:`
...
`;V(document.querySelector("#nav"));H(document.querySelector("#about"));A(document.querySelector("#experience"));D(document.querySelector("#projects"));z(document.querySelector("#links"));L(document.querySelector("#footer"));
